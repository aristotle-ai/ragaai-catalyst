...
TRACE_DIR = os.environ.get("RAGAAI_TRACE_DIR", "trace_crewai")
...
def run_diagnosis_agent():
    ...
    try:
        ...
        if trace_file_path and os.path.exists(trace_file_path):
            ...
            print(f"Warning: No trace file found after running scifi_writer.py. Trying shell command...")
...
def setup_traces():
    ...
    if not trace_file_path:
        print(f"No trace file found in {TRACE_DIR} directory, running scifi_writer.py to generate it")
