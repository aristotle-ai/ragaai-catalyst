...
TRACE_DIR = os.environ.get("RAGAAI_TRACE_DIR", "trace_llamaindex")
...
def run_news_fetching_agent():
    ...
    try:
        ...
        if trace_file_path and os.path.exists(trace_file_path):
            ...
            print(f"Warning: No trace file found after running legal_rag.py. Trying shell command...")
...
def setup_traces():
    ...
    if not trace_file_path:
        print(f"No trace file found in {TRACE_DIR} directory, running legal_rag.py to generate it")
